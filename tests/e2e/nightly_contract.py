...
NIGHTLY_E2E_SUITE_CONTRACT = (
    ...
    "for YOLO-NAS), plus the public DeepLabv3 semantic family; gaze "
    "(L2CS/Gaze360) is non-redistributable and runs only in "
    "the non-gated per-family suite, not the gated nightly; classification "
