...
is a native port of EfficientNetV2-base (the accuracy tier); and `deit` is an
inference-only museum port of the plain DeiT patch-16 classifiers. All are
...
256 for MobileNetV4-l; 224/240/260/300 for EfficientNetV2 b0–b3) rather than timm's
