...
| Family | Task | onnx | torchscript | executorch | tensorrt | openvino | mnn | ncnn | tflite | coreml | coreai |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
...
- `alexnet` / `classify` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `birefnet` / `matte` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `centernet` / `detect` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `clip` / `classify` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `clip` / `embed` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `convnext` / `classify` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `deformable_detr` / `detect` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `deim` / `detect` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `deimv2` / `detect` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `deit` / `classify` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `depth_anything` / `depth` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `detr` / `detect` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `dexined` / `edge` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `dfine` / `detect` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `dfine` / `segment` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `dinodetr` / `detect` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `dinov2` / `classify` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `dinov2` / `embed` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `ec` / `detect` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `ec` / `pose` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `ec` / `segment` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `efficientdet` / `detect` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `efficientnetv2` / `classify` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `faster_rcnn` / `detect` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `fcos` / `detect` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `feynobg` / `matte` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `lwdetr` / `detect` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `midas` / `depth` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `mobilenetv4` / `classify` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `nafnet` / `restore` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `picodet` / `detect` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `realesrgan` / `restore` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
- `realesrgan` / `restore` / `coreml`: This family and task are not covered by the family-aware CoreML wrapper.
- `resnet` / `classify` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `retinanet` / `detect` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `rfdetr` / `segment` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `rfdetr` / `pose` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `rfdetr` / `obb` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `rtdetr` / `detect` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `rtdetrv2` / `detect` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `rtdetrv4` / `detect` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `rtmdet` / `detect` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `siglip2` / `classify` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `siglip2` / `embed` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `ssd` / `detect` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `swin` / `classify` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `swinir` / `restore` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `teed` / `edge` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `vgg` / `classify` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `vit` / `classify` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `yolo1` / `detect` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `yolo2` / `detect` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `yolo3` / `detect` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `yolo4` / `detect` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `yolo7` / `detect` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `yolo9_e2e` / `detect` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `yolo9_p2` / `detect` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `yolonas` / `detect` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
- `yolonas` / `detect` / `coreml`: This family and task are not covered by the family-aware CoreML wrapper.
- `yolonas` / `pose` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
...
- `yolox` / `detect` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
- `zipdepth` / `depth` / `mnn`: MNN v1 supports YOLO9 and RF-DETR detection exports only.
