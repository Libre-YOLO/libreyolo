...
def __getattr__(name):
    ...
    _lazy = {
        ...
        "LibreHolo": (".models.ground", "LibreHolo"),
        "LibreUITARS": (".models.ground", "LibreUITARS"),
        "LibreTinyClick": (".models.ground", "LibreTinyClick"),
        "LibreGroundFlorence2": (".models.ground", "LibreGroundFlorence2"),
        "LibreGroundLocateAnything": (".models.ground", "LibreGroundLocateAnything"),
        "LibreGroundMoondream": (".models.ground", "LibreGroundMoondream"),
