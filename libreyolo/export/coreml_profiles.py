...
_PROFILES = (
    ...
    _profile(
        ...
        "n",
        518,
        "official DINOv2-S backbone + deterministic 3-class dense head",
        source_kind="pytorch-traced-graph-state-v2",
        source_sha256=(
            "2992b62e85a58b58f9e48affa9b3f79f"
            "42c9f26a193002a63714f4ca9c7f0b38"
        ),
        deployment_abi_sha256=(
            "684cbd5399e49d9dec0c0705b435bd22"
            "3b58a3b832bb94a282a89c64fb9b721f"
        ),
        evidence_sha256=(
            "ae1f8cdc4b636ad36234b84335defa44"
            "b143b0b722f55e5ba4a827f44a4cc68b"
        ),
        class_count=3,
    ),
    _profile(
    ...
    *(
    ...
    _profile(
        ...
        "t",
        960,
        "LibrePPOCRt-ocr multifunction det/rec package",
        source_kind="pytorch-module-state-v1",
        source_sha256=(
            "ff16fbd3130a9f4dfcdfd14c6ee0da95"
            "baf55d431e822b609d3f39d7a84f9fbf"
        ),
        deployment_abi_sha256=(
            "2b4b739db9fd8cfbfcfe356806c4b784"
            "f83b384e8e9d391c2aac0ab354361963"
        ),
        evidence_sha256=(
            "2b74f0d1a9e62b8ba54b8cc1a675be9"
            "6869088c08f0aa94b18a04537b86c61d8"
        ),
        class_count=1,
    ),
    _profile(
